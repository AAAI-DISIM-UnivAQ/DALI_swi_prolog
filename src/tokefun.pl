...
:- multifile user:term_expansion/2, scrittura/1.
...
crea_rand(F,T):-random_between(97,122,A4),random_between(97,122,A5),random_between(97,122,A6),name(F,Lf),append(Lf,[A4],F1),append(F1,[A5],F2),append(F2,[A6],Fi),name(T,Fi).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
examine_variable(Me):-name(Me,L),append([86,97,114,95],L,Lt),re_write(Lt).
...
examine_variable_le(Me,Nf):-name(Me,L),append([86,97,114,95],L,Lt),re_write1(Lt,Nf).
