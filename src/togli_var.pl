...
isa_code_var(L):-nth0(0,L,El0),nth0(1,L,El1),nth0(2,L,El2),nth0(3,L,El3),El0=86,El1=97,El2=114,El3=95.


disapp_variable_var(L):-append([86,97,114,95],Lt,L),re_write_var(Lt).
